...
export const fetchLectures = TryCatch(async (req, res) => {
  ...
  // ✅ Allow free course access even if not subscribed
  if (course.price === 0) {
    return res.json({ lectures });
  }
...
export const fetchLecture = TryCatch(async (req, res) => {
  ...
  // ✅ Allow access to free course lectures
  if (course.price === 0) {
    return res.json({ lecture });
  }
...
// Checkout and auto-subscribe if course is free
export const checkout = TryCatch(async (req, res) => {
  ...
  if (course.price === 0) {
    ...
    return res.status(200).json({
      message: "Course added successfully (Free course)",
      course,
    });
  }
